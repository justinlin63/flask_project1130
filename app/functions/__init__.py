...
route_list = [home_blueprint, cart_blueprint, login_blueprint, registers_blueprint, pay_blueprint, orders_blueprint, admin_blueprint, reset_password_blueprint, redirect_blueprint]
